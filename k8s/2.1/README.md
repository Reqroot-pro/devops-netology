...
[manifests/containers-data-exchange.yaml](https://github.com/Reqroot-pro/devops-netology/blob/main/k8s/2.1/manifests/containers-data-exchange.yaml)

![](https://github.com/Reqroot-pro/devops-netology/blob//main/k8s/2.1/images/01.png)
![](https://github.com/Reqroot-pro/devops-netology/blob//main/k8s/2.1/images/02.png)
...
[manifests/pv-pvc.yaml](https://github.com/Reqroot-pro/devops-netology/blob/main/k8s/2.1/manifests/pv-pvc.yaml)

![](https://github.com/Reqroot-pro/devops-netology/blob//main/k8s/2.1/images/03.png)
![](https://github.com/Reqroot-pro/devops-netology/blob//main/k8s/2.1/images/04.png)
![](https://github.com/Reqroot-pro/devops-netology/blob//main/k8s/2.1/images/05.png)
![](https://github.com/Reqroot-pro/devops-netology/blob//main/k8s/2.1/images/06.png)
После выполнения команды kubectl delete pvc local-pvc ресурс PV не удалился, а перешёл в статус Released.
Причина:
Это поведение определяется политикой возврата ресурсов, заданной в манифесте PV: 
persistentVolumeReclaimPolicy: Retain

![](https://github.com/Reqroot-pro/devops-netology/blob//main/k8s/2.1/images/07.png)
После выполнения команды kubectl delete pv local-pv файл app.log остался на хосте в директории /var/snap/microk8s/common/pv-data/.
Причина:
Тип хранилища hostPath создаёт прямую ссылку на файловую систему узла (ноды).
